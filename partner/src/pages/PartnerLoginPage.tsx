  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: '12px', borderTop: '4px solid #059669',
        ...
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          <div style={{
            ...
            <Handshake size={28} style={{ color: '#059669' }} />
          </div>
        ...
        {mfaToken ? (
          <form onSubmit={handleMfaSubmit}>
            <div style={{ textAlign: 'center', marginBottom: '16px' }}>
              <div style={{ fontSize: '14px', color: '#059669', fontWeight: 600, marginBottom: '4px' }}>
                2단계 인증이 필요합니다
              </div>
            ...
            <button
              ...
              style={{
                ...
                color: '#fff', backgroundColor: (loading || mfaCode.length !== 6) ? '#8b95a1' : '#059669',
          ...
          <>
            ...
            {isWebAuthnSupported() && (
              <>
                <button
                  ...
                  style={{
                    width: '100%', padding: '12px', fontSize: '15px', fontWeight: 600,
                    color: '#fff', backgroundColor: (loading || !email) ? '#8b95a1' : '#059669',
                    border: 'none', borderRadius: '10px',
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                style={{
                  width: '100%', padding: '12px', fontSize: '15px', fontWeight: 600,
                  color: '#fff', backgroundColor: loading ? '#8b95a1' : '#059669',
