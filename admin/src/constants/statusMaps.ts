...
export const TRADEIN_STATUS_MAP: Record<string, StatusConfig> = {
  ...
  'FRAUD_HOLD': {
    ...
    class: 'bg-danger-light text-danger',
    color: 'red',
    description: '사기 의심으로 보류된 매입 건입니다.',
  },
};
 ...
 * 바우처 출처 맵
 */
export const VOUCHER_SOURCE_MAP: Record<string, StatusConfig> = {
  'ADMIN': {
    label: '직영',
    class: 'bg-primary-light text-primary',
    color: 'blue',
  ...
  'PARTNER': {
    label: '파트너',
    class: 'bg-accent-light text-accent',
    color: 'teal',
  },
};
