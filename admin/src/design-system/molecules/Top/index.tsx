...
const TitleTextButton = memo<TopTitleTextButtonProps>(({
  ...
  const fontSize = size === 'xxlarge' ? '28px' : size === 'xlarge' ? '22px' : '18px';
...
const RightButton = memo<TopRightButtonProps>(({
  ...
  return (
    <Button
      ...
      size={size === 'xlarge' ? 'lg' : size === 'large' ? 'lg' : size === 'medium' ? 'md' : 'sm'}
      onClick={onClick}
...
const LowerButton = memo<TopLowerButtonProps>(({
  ...
  return (
    <Button
      variant="ghost"
      size={size === 'xlarge' || size === 'large' ? 'lg' : size === 'medium' ? 'md' : 'sm'}
      onClick={onClick}
