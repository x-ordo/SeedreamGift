 ...
 */
export function exportBankSubmissionReport(
 ...
 * 합계 행 + 발급정보 포함
 */
export function exportUserTransactionReport(
  ...
  const summaryRow: UserTransactionRow = {
    ...
    paymentMethod: '',
    note: `발급일: ${today} | ${siteConfig.company.nameShort} (${siteConfig.urls.domain})`,
  };
