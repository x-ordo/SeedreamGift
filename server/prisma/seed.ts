...
async function main() {
  ...
  const notices = [
    ...
    },
    {
      ...
      content:
        '와우기프트에서 처음 상품권을 구매하시는 회원님께 5% 추가 할인을 드립니다!\n\n- 기간: 2025.01.29 ~ 2025.02.28\n- 대상: 첫 구매 회원\n- 혜택: 결제 금액 5% 즉시 할인\n\n많은 참여 부탁드립니다.',
      isActive: true,
      viewCount: 450,
  ...
  const events = [
    ...
    },
    {
      title: '첫 구매 회원 특별 혜택',
      description:
        '와우기프트에서 처음 상품권을 구매하시는 회원님께 5% 추가 할인을 드립니다. 지금 바로 가입하고 혜택을 받아보세요!',
      imageUrl: null,
    ...
    },
    {
      title: '매입 수수료 0원 이벤트',
      description:
        '보유하신 상품권을 와우기프트에서 매입하시면 수수료 0원! 최고가 매입 보장.',
      imageUrl: null,
  ...
  const faqs = [
    ...
    // SHIPPING 카테고리
    {
      ...
      answer:
        '아니요, 와우기프트에서 판매하는 상품권은 모두 모바일 상품권(PIN 번호)입니다.\n\n• 결제 완료 즉시 PIN 번호 발급\n• 마이페이지에서 즉시 확인 가능\n• 별도 배송 없음\n\n실물 상품권이 필요하신 경우 백화점 고객센터에 문의해주세요.',
      category: 'SHIPPING',
      order: 1,
      isActive: true,
      helpfulCount: 55,
