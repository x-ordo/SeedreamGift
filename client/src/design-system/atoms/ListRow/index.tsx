...
export type ListRowVerticalPadding = 'sm' | 'md' | 'lg' | 'xl';
export type ListRowHorizontalPadding = 'sm' | 'md';
...
const AssetIcon = memo<ListRowAssetIconProps>(({
  ...
  const effectiveSize = isCircle ? 'lg' : size;
  ...
  return (
    <>
      {Array.from({ length: rows }, (_, i) => (
        <div key={i} className={`list-row list-row--padding-md ${className}`}>
          {leftShape && (
