...
export const Modal = ({
    ...
    useEffect(() => {
        ...
        // iOS Safari 배경 스크롤 방지 — position: fixed로 스크롤 위치 보존
    ...
    return createPortal(
        <div
            ...
            onClick={closeOnOverlayClick ? (e) => { e.preventDefault(); e.stopPropagation(); onClose(); } : undefined}
            onTouchEnd={closeOnOverlayClick ? (e) => { e.preventDefault(); } : undefined}
            role="presentation"
        >
